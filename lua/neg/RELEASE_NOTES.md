...
- Git palette refresh: diff/GitSigns colors now use a cohesive dark-spruce / cool indigo / burgundy trio (`GitSigns*`, `diff*`, diagnostics) tuned to stay cold, saturated, but non-neon across signs, gutters, and virtual text.
