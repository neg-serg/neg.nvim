...
local Commander = require('neg.commands')
...
-- User commands
  ...
  local commander = Commander.new({
    ...
    palette = p,
    get_config = function() return M._config or default_config end,
    apply_config = function(cfg) M.setup(cfg) end,
    get_scenarios = function()
      M._scenarios = M._scenarios or {}
      return M._scenarios
    end,
    pick_scenario_fields = pick_scenario_fields,
    apply_scenario_tbl = function(tbl, mode) apply_scenario_tbl(tbl, mode) end,
    default_scenarios_path = default_scenarios_path,
  })
  commander:register()
