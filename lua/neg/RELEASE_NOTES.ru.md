...
- Telekasten/Markdown UI: новые оттенки в палитре и отдельный модуль для Telekasten перекрашивают теги и wiki-скобки в глубокий холодный угольный цвет, так что счётчики и элементы панели становятся заметнее, при этом diff-цвета не трогаются.
