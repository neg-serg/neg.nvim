...
- Git-палитра: все `diff*`/`GitSigns*`/диагностики получили новую холодную связку (тёмная ель для добавлений, холодный индиго для изменений, малиновый для удалений) — насыщенно, но без кислотности, в духе остальной палитры.
